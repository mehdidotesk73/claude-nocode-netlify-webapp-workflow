...
.claude/skills/
  ...
  add-statefulness/SKILL.md  decide what kind of state an app needs, confirm it, route to the rest
  add-database/SKILL.md    Supabase setup, once add-statefulness has settled that it's needed
